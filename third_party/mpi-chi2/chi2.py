...
if __name__ == "__main__":
    ...
    dim=3000
    X1 = array( random_integers(1, 10, 1000*dim), c_float)
    X1.shape = (-1,dim)
    X2 = array( random_integers(1, 10, 2000*dim), c_float)
    X2.shape = (-1,dim)
    ...
    X1 = array( random_integers(1, 10, 1000*dim), c_double)
    X1.shape = (-1,dim)
    X2 = array( random_integers(1, 10, 2000*dim), c_double)
    X2.shape = (-1,dim)
